...
- Spec is for greenfield code with no existing codebase to ground against — Phase 1/2/3 produce noise (but Phase 8's data-availability and request-shape seams still apply: they reconcile the spec's *own* new producer/consumer contracts against each other, not against code)
